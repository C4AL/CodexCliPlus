...
{
    Task<ManagementApiResponse<ManagementConfigSnapshot>> GetConfigAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<string>> GetConfigYamlAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> PutConfigYamlAsync(
        string yamlContent,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UpdateBooleanSettingAsync(
        string path,
        bool value,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UpdateIntegerSettingAsync(
        string path,
        int value,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UpdateStringSettingAsync(
        string path,
        string value,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> DeleteSettingAsync(
        string path,
        CancellationToken cancellationToken = default
    );
}
...
{
    Task<ManagementApiResponse<IReadOnlyList<ManagementGeminiKeyConfiguration>>> GetGeminiKeysAsync(
        CancellationToken cancellationToken = default
    );
    ...
    Task<ManagementApiResponse<ManagementAmpCodeConfiguration>> GetAmpCodeAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UpdateAmpUpstreamUrlAsync(
        string? upstreamUrl,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UpdateAmpUpstreamApiKeyAsync(
    ...
    Task<ManagementApiResponse<ManagementOperationResult>> SetAmpForceModelMappingsAsync(
        bool enabled,
        CancellationToken cancellationToken = default
    );
}
...
{
    Task<ManagementApiResponse<IReadOnlyList<ManagementAuthFileItem>>> GetAuthFilesAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UploadAuthFileAsync(
        string fileName,
        string jsonContent,
        CancellationToken cancellationToken = default
    );
    ...
    Task<ManagementApiResponse<ManagementOperationResult>> DeleteAuthFileAsync(
        string name,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> DeleteAuthFilesAsync(
        IReadOnlyList<string> names,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> DeleteAllAuthFilesAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<string>> DownloadAuthFileAsync(
        string name,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> SetAuthFileDisabledAsync(
        string name,
        bool disabled,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> PatchAuthFileFieldsAsync(
        ManagementAuthFileFieldPatch patch,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<IReadOnlyList<ManagementModelDescriptor>>> GetAuthFileModelsAsync(
        string name,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<IReadOnlyList<ManagementModelDescriptor>>> GetModelDefinitionsAsync(
        string channel,
        CancellationToken cancellationToken = default
    );
}
...
public interface IManagementOAuthService
{
    ...
    Task<ManagementApiResponse<ManagementOAuthStartResponse>> GetOAuthStartAsync(
        string provider,
        string? projectId = null,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOAuthStatus>> GetOAuthStatusAsync(
        string state,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> SubmitOAuthCallbackAsync(
        string provider,
        string redirectUrl,
        CancellationToken cancellationToken = default
    );
...
{
    Task<ManagementApiResponse<ManagementConfigSnapshot>> GetQuotaSettingsAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> SetSwitchProjectAsync(
        bool enabled,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> SetSwitchPreviewModelAsync(
        bool enabled,
        CancellationToken cancellationToken = default
    );
}
...
public interface IManagementAuthService
    : IManagementProvidersService,
        IManagementAuthFilesService,
        IManagementOAuthService
{
    Task<ManagementApiResponse<IReadOnlyList<string>>> GetApiKeysAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> ReplaceApiKeysAsync(
        IReadOnlyList<string> apiKeys,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> UpdateApiKeyAsync(
        int index,
        string value,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> DeleteApiKeyAsync(
        int index,
        CancellationToken cancellationToken = default
    );
}
...
{
    Task<ManagementApiResponse<ManagementUsageSnapshot>> GetUsageAsync(
        CancellationToken cancellationToken = default
    );
    ...
    Task<ManagementApiResponse<ManagementUsageImportResult>> ImportUsageAsync(
...
{
    Task<ManagementApiResponse<ManagementLogsSnapshot>> GetLogsAsync(
        long after = 0,
        int limit = 0,
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<ManagementOperationResult>> ClearLogsAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<IReadOnlyList<ManagementErrorLogFile>>> GetRequestErrorLogsAsync(
        CancellationToken cancellationToken = default
    );

    Task<ManagementApiResponse<string>> GetRequestLogByIdAsync(
        string id,
        CancellationToken cancellationToken = default
    );
}
...
{
    Task<ManagementApiResponse<ManagementLatestVersionInfo>> GetLatestVersionAsync(
        CancellationToken cancellationToken = default
    );
    ...
    Task<ManagementApiResponse<ManagementApiCallResult>> ExecuteApiCallAsync(
