...
{
    private static readonly HashSet<string> WebUiSupportedProviders = new(
    ...
    public async Task<ManagementApiResponse<IReadOnlyList<string>>> GetApiKeysAsync(
    ...
    )
    {
        ...
        return ManagementResponseFactory.Map(
            response,
            ManagementMappers.MapApiKeys(document.RootElement)
        );
    }
    ...
    )
    {
        ...
        if (validFiles.Length == 0)
        {
            return CreateOperationResponse(
                new ManagementOperationResult { Status = "ok", Uploaded = 0 }
            );
        }
    ...
    )
    {
        ...
        {
            return CreateOperationResponse(
                new ManagementOperationResult { Status = "ok", Deleted = 0 }
            );
        }

        var query = string.Join(
            "&",
            normalizedNames.Select(name => $"name={Uri.EscapeDataString(name)}")
        );
        return await SendOperationAsync(
            HttpMethod.Delete,
            $"auth-files?{query}",
    ...
    > GetGeminiKeysAsync(CancellationToken cancellationToken = default)
    {
        return GetMappedAsync(
            "gemini-api-key",
            root => ManagementMappers.MapConfig(root).GeminiApiKeys,
            cancellationToken
        );
    }
    ...
    > GetCodexKeysAsync(CancellationToken cancellationToken = default)
    {
        return GetMappedAsync(
            "codex-api-key",
            root => ManagementMappers.MapConfig(root).CodexApiKeys,
            cancellationToken
        );
    }
    ...
    > GetClaudeKeysAsync(CancellationToken cancellationToken = default)
    {
        return GetMappedAsync(
            "claude-api-key",
            root => ManagementMappers.MapConfig(root).ClaudeApiKeys,
            cancellationToken
        );
    }
    ...
    > GetVertexKeysAsync(CancellationToken cancellationToken = default)
    {
        return GetMappedAsync(
            "vertex-api-key",
            root => ManagementMappers.MapConfig(root).VertexApiKeys,
            cancellationToken
        );
    }
    ...
    > GetOpenAiCompatibilityAsync(CancellationToken cancellationToken = default)
    {
        return GetMappedAsync(
            ...
            root => ManagementMappers.MapConfig(root).OpenAiCompatibility,
            cancellationToken
        );
    }
    ...
    )
    {
        return SendOperationAsync(
            HttpMethod.Patch,
            "gemini-api-key",
            BuildIndexedPayload(index, configuration),
            cancellationToken
        );
    }
    ...
    )
    {
        return SendOperationAsync(
            HttpMethod.Delete,
            BuildProviderDeletePath("gemini-api-key", apiKey, baseUrl),
            payload: null,
            cancellationToken: cancellationToken
        );
    }
    ...
    )
    {
        return SendOperationAsync(
            HttpMethod.Delete,
            BuildProviderDeletePath("codex-api-key", apiKey, baseUrl),
            payload: null,
            cancellationToken: cancellationToken
        );
    }
    ...
    )
    {
        return SendOperationAsync(
            HttpMethod.Delete,
            BuildProviderDeletePath("claude-api-key", apiKey, baseUrl),
            payload: null,
            cancellationToken: cancellationToken
        );
    }
    ...
    )
    {
        return SendOperationAsync(
            HttpMethod.Delete,
            BuildProviderDeletePath("vertex-api-key", apiKey, baseUrl),
            payload: null,
            cancellationToken: cancellationToken
        );
    }
    ...
    )
    {
        return SendOperationAsync(
            HttpMethod.Patch,
            "openai-compatibility",
            BuildIndexedPayload(index, provider),
            cancellationToken
        );
    }
    ...
    public async Task<ManagementApiResponse<ManagementAmpCodeConfiguration>> GetAmpCodeAsync(
        CancellationToken cancellationToken = default
    )
    {
        var response = await _apiClient.SendManagementAsync(
        ...
        using var document = ManagementJson.Parse(response.Value);
        var ampCode =
            ManagementMappers.MapConfig(document.RootElement).AmpCode
            ?? new ManagementAmpCodeConfiguration();
    ...
    )
    {
        return string.IsNullOrWhiteSpace(upstreamUrl)
            ...
            : SendOperationAsync(
                HttpMethod.Put,
                "ampcode/upstream-url",
                new Dictionary<string, object?> { ["value"] = upstreamUrl.Trim() },
                cancellationToken
            );
    }
    ...
    )
    {
        return string.IsNullOrWhiteSpace(upstreamApiKey)
            ...
            : SendOperationAsync(
                HttpMethod.Put,
                "ampcode/upstream-api-key",
                new Dictionary<string, object?> { ["value"] = upstreamApiKey.Trim() },
                cancellationToken
            );
    }
    ...
    > GetOAuthExcludedModelsAsync(CancellationToken cancellationToken = default)
    {
        ...
        return ManagementResponseFactory.Map(
            response,
            ManagementMappers.MapOAuthExcludedModels(document.RootElement)
        );
    }
    ...
    > GetOAuthModelAliasesAsync(CancellationToken cancellationToken = default)
    {
        ...
        return ManagementResponseFactory.Map(
            response,
            ManagementMappers.MapOAuthModelAliases(document.RootElement)
        );
    }
    ...
    )
    {
        ...
        return ManagementResponseFactory.Map(
            response,
            ManagementMappers.MapOAuthStart(document.RootElement)
        );
    }

    public async Task<ManagementApiResponse<ManagementOAuthStatus>> GetOAuthStatusAsync(
        string state,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return ManagementResponseFactory.Map(
            response,
            ManagementMappers.MapOAuthStatus(document.RootElement)
        );
    }
    ...
    {
        var normalizedProvider = string.Equals(
            provider,
            "gemini-cli",
    ...
    private static ManagementApiResponse<ManagementOperationResult> CreateOperationResponse(
    ...
    {
        return new Dictionary<string, object?> { ["index"] = index, ["value"] = value };
    }
    ...
    private static string BuildOAuthStartPath(string provider, string? projectId)
    {
        ...
        if (
            string.Equals(normalizedProvider, "gemini-cli", StringComparison.OrdinalIgnoreCase)
