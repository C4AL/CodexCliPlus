...
public sealed class ResourceSourceManifestTests
{
    ...
    [
        "src/CodexCliPlus.Assets/fonts/Fgi-Regular.ttf",
        "src/CodexCliPlus.Assets/fonts/MiSans-Regular.ttf",
        "src/CodexCliPlus.Assets/icons/codexcliplus-display.png",
        "src/CodexCliPlus.Assets/icons/codexcliplus.ico",
        "src/CodexCliPlus.Assets/icons/ico-transparent.png",
        "src/CodexCliPlus.WebUi/logo.jpg",
    ];
    ...
    public async Task SourceManifestCoversTrackedBinaryResourcesAndMatchesHashes()
    {
        ...
        foreach (var trackedBinaryPath in GetTrackedBinaryResourcePaths(repositoryRoot))
        {
            Assert.True(
                ...
                $"Tracked binary resource is missing from src/CodexCliPlus.Assets/source-manifest.json: {trackedBinaryPath}"
            );
        }
    ...
    private static string[] GetTrackedBinaryResourcePaths(string repositoryRoot)
    {
        ...
        startInfo.ArgumentList.Add("src/CodexCliPlus.Assets");
        startInfo.ArgumentList.Add("src/CodexCliPlus.WebUi/logo.jpg");
