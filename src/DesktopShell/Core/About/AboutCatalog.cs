...
public static class AboutCatalog
{
    ...
    [
        new(
            ...
            Path.Combine("src", "Packaging", "Assets", "licenses", "CodexCliPlus.MIT.txt"),
        ...
        new(
            ...
            Path.Combine("src", "Packaging", "Assets", "licenses", "CLIProxyAPI.MIT.txt"),
        ...
        new(
            ...
            "内置前端源码与静态资源遵循 MIT 许可。"
        ),
        new(
            "BetterGI 派生 UI 许可",
            "GPL-3.0",
            "BetterGI.GPL-3.0.txt",
            Path.Combine("src", "Packaging", "Assets", "licenses", "BetterGI.GPL-3.0.txt"),
        ...
        new(
            ...
            Path.Combine("src", "Packaging", "Assets", "licenses", "cpa-usage-keeper.MIT.txt"),
        ...
        new(
            ...
            "NOTICE",
            "NOTICE.txt",
            Path.Combine("src", "Packaging", "Assets", "licenses", "NOTICE.txt"),
            "发行包中的合并来源与许可说明。"
        ),
    ];
}
