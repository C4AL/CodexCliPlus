...
import { VisualConfigEditor } from '@/ui/VisualConfigEditor';
import { DiffModal } from '@/ui/DiffModal';
import { useDesktopDataChanged } from '@/hooks/useDesktopDataChanged';
import { useVisualConfig } from '@/hooks/useVisualConfig';
import { useNotificationStore, useAuthStore, useThemeStore, useConfigStore } from '@/state';
import { configFileApi } from '@/api/configFile';
import styles from '@/styles/ConfigPage.module.scss';

type ConfigEditorTab = 'visual' | 'source';

const LazyConfigSourceEditor = lazy(() => import('@/ui/ConfigSourceEditor'));
