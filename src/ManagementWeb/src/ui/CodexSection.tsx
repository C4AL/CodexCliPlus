...
import { calculateStatusBarData, type KeyStats } from '@/lib/usage';
import { type UsageDetailsByAuthIndex, type UsageDetailsBySource } from '@/lib/usageIndex';
...
export function CodexSection({
  ...
  const statusBarCache = useMemo(() => {
    ...
    return cache;
  }, [configs, keyStats, usageDetailsByAuthIndex, usageDetailsBySource]);
