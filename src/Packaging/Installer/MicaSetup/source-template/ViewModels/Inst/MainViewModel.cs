...
public partial class MainViewModel : ObservableObject
{
    ...
    public string MaintenanceTitle => string.Empty;
    public string InstalledSummary => string.Empty;
    public string UpdateButtonText => string.Empty;
    public string RepairButtonText => string.Empty;
    public string UninstallButtonText => string.Empty;
    public string KeepMyDataText => string.Empty;
    public bool KeepMyData { get; set; }
