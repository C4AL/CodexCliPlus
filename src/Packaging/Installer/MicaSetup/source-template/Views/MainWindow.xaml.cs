...
public partial class MainWindow : FluentWindow
{
    ...
    private void OnClosing(object sender, CancelEventArgs e)
    {
        ...
        else
        {
            ...
            {
                var message = Option.Current.MaintenanceAction == SetupMaintenanceAction.Uninstall
                    ? "UninstNotCompletedTips".Tr()
                    : "InstNotCompletedTips".Tr();

                if (MessageBox.Question(this, message) != WindowDialogResult.Yes)
                {
                    e.Cancel = true;
                }
            }
