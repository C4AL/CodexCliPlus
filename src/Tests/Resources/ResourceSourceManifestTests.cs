...
public sealed class ResourceSourceManifestTests
{
    ...
    [
        "src/Packaging/Assets/fonts/MiSans-Regular.ttf",
        "src/Packaging/Assets/icons/codexcliplus-display.png",
        "src/Packaging/Assets/icons/codexcliplus.ico",
        "src/ManagementWeb/logo.jpg",
    ];
    ...
    public async Task SourceManifestCoversTrackedBinaryResourcesAndMatchesHashes()
    {
        ...
        foreach (var trackedBinaryPath in GetTrackedBinaryResourcePaths(repositoryRoot))
        {
            Assert.True(
                ...
                $"Tracked binary resource is missing from src/Packaging/Assets/source-manifest.json: {trackedBinaryPath}"
            );
        }
    ...
    private static string[] GetTrackedBinaryResourcePaths(string repositoryRoot)
    {
        ...
        startInfo.ArgumentList.Add("src/Packaging/Assets");
        startInfo.ArgumentList.Add("src/ManagementWeb/logo.jpg");
