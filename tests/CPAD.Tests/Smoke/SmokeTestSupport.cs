...
internal sealed class SmokeEnvironmentScope : IDisposable
{
    ...
    public SmokeEnvironmentScope(string mode = "development")
    {
        ...
        RootDirectory = Path.Combine(Path.GetTempPath(), $"cpad-smoke-{Guid.NewGuid():N}");
    ...
    private static string FindRepositoryRoot()
    {
        ...
        throw new DirectoryNotFoundException("Could not locate CliProxyApiDesktop.sln from the test output directory.");
    }
